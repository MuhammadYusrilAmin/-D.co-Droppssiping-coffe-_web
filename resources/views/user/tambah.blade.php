                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 ">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid  @enderror" id="basic-icon-default-nama" placeholder="Tegar Karunia" name="nama" value="{{old('nama')}}" aria-describedby="basic-icon-default-nama2" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 ">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('no_telp') is-invalid  @enderror" id="basic-icon-default-name" placeholder="085xxxxxxxxx" name="no_telp" value="{{old('no_telp')}}" aria-describedby="basic-icon-default-no_telp2" />
